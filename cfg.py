...
Cfg.train_label = os.path.join(_BASE_DIR, 'dataset', 'tabacco', 'train', '_annotations.txt')
Cfg.val_label = os.path.join(_BASE_DIR, 'dataset', 'tabacco', 'valid', '_annotations.txt')
