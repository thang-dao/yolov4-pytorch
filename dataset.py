...
class Yolo_dataset(Dataset):
    def __init__(self, label_path, cfg, train=True):
        ...
        # if train:
        #     self.cfg.dataset_dir = self.cfg.dataset_dir + '/train'
        # else:
        #     self.cfg.dataset_dir = self.cfg.dataset_dir + '/valid'
    ...
    def _get_val_item(self, index):
        ...
        img = cv2.imread(os.path.join(self.cfg.dataset_dir + '/valid', img_path))
